...
def get_message_for_state(state: ConversationState, user_id: int) -> str:
    messages = {
        ...
        ConversationState.ADVENTURE_DETAILS: "Which activities are you participating in? (E.g., scuba diving, parasailing)",
        ConversationState.MEDICAL_CONDITIONS: "Do you have any pre-existing medical conditions?",
        ConversationState.MEDICAL_DETAILS: "Please specify if you'd like additional support for your condition: (E.g., heart attacks, asthma, diabetes)",
